...
export default function EstimatePdf({
  ...
  const gstAmount = Math.round(estimate.grandTotal * 0.18);
  const grandTotalWithGst = estimate.grandTotal + gstAmount;
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>Factory-Built RCC Structure (GFRC/TRC)</Text>
          </View>
          <View style={styles.row}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{formatINR(estimate.grandTotal)}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>GST @ 18%</Text>
            <Text style={styles.value}>+ {formatINR(gstAmount)}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Transportation</Text>
            <Text style={styles.value}>As per distance (Extra)</Text>
          </View>
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>ESTIMATED TOTAL (incl. GST)</Text>
            <Text style={styles.totalValue}>{formatINR(grandTotalWithGst)}</Text>
          </View>
          <Text style={styles.noteText}>* Transportation charges will be calculated based on delivery distance and added separately.</Text>
        </View>
